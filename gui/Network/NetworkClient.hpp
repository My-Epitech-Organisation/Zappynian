...
public:
  ...
  void createWorld() override {
    ...
    setPlayerLevel(2, 2);
    try {
      createPlayer(3, 0, 0, Direction::EAST, 0, "Red");
    } catch (const std::exception &e) {
    }
    setPlayerLevel(3, 3);

    try {
      createPlayer(4, 0, 1, Direction::EAST, 0, "Yellow");
    } catch (const std::exception &e) {
    }
    setPlayerLevel(4, 4);
    try {
      createPlayer(5, 0, 2, Direction::EAST, 0, "Purple");
    } catch (const std::exception &e) {
    }
    setPlayerLevel(5, 5);
    try {
      createPlayer(6, 0, 3, Direction::EAST, 0, "Orange");
    } catch (const std::exception &e) {
    }
    setPlayerLevel(6, 6);
    try {
      createPlayer(7, 0, 4, Direction::EAST, 0, "Green");
    } catch (const std::exception &e) {
    }
    setPlayerLevel(7, 7);
    try {
      createPlayer(8, 1, 0, Direction::NORTH, 0, "Green");
    } catch (const std::exception &e) {
    }
    setPlayerLevel(8, 8);
